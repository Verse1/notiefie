...
function AddClassButton(props) {
    ...
    return (
        <button className={`${color} ${hover} hover:before:content-['Remove Class'] text-gray-100 font-bold py-2 px-4 rounded inline-flex items-center mb-5 mr-5`} onClick={handleClick}>
