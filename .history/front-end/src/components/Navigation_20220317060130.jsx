...
function Navigation(props) {
  ...
  return(
<<<<<<< HEAD:front-end/src/components/Navigation.js
    <nav className="bg-indigo-800 p-2 mt-0 fixed w-full z-10 top-0 mb-8">
=======
    <nav className="bg-indigo-800 p-2 mt-0 fixed w-full z-10 top-0 relative">
>>>>>>> origin/verse:front-end/src/components/Navigation.jsx
