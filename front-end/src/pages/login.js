...
export default function Login() {
  const { isAuthenticated, loginWithPopup, logout, loginWithRedirect, user } = useAuth0();
  ...
  return (
    <div className="grid h-[88vh] place-items-center">
      <div className="bg rounded-3xl bg-white p-7">
        {user ? <div className="content-center"><h1 className="mb-7 text-center text-2xl">
          Log Out of Notiefi
        </h1>
        <button
          ...
          onClick={logout}>
          Logout
        </button></div> : <div className="content-center"><h1 className="mb-7 text-center text-2xl">
